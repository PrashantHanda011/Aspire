...
function Community() {
  ...
  return (
    <div className='perfectSection'>
        ...
        <Carousel NextIcon={<ArrowForwardIosIcon/>} PrevIcon={<ArrowBackIosIcon/>} animation="slide" navButtonsAlwaysVisible={true}
...
{
    return (
        <Card className="communityCard" style={{width: "80%", margin: "auto", marginTop: 50, marginBottom: 50}}>
            <Row>
                <Col xs={3}>
