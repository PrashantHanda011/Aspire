...
function Community(prop) {
  ...
  return (
    <div  className='perfectSection ' style={{background:`${prop?.color ? (prop?.color):(null)}`}}>
        ...
        <Carousel    animation="slide" style={{overflow:"visible"}} overFlow="visible" navButtonsAlwaysVisible={false}
...
{
    return (
        <Card className="communityCard" style={{width: "90%", margin: "auto",borderRadius:"10px",overFlow:"visible",    boxShadow: " 0px 0px 14px rgba(0, 0, 0, 0.1)"}}>
            <Row className="d-flex flex-lg-row flex-column">
                <Col className="CarouselCard" lg={4}>
                ...
                <h3 className="CarouselDate">26,June,2022</h3>
                <h2 style={{fontSize: 34, fontWeight: 600, color: "#525252"}}>{props.item.name}</h2>
