...
{
    return (
        <Card className="communityCard" style={{width: "80%", margin: "auto",borderRadius:"10px",overFlow:"visible",    boxShadow: " 0px 0px 14px rgba(0, 0, 0, 0.1)"}}>
            <Row>
                <Col className="CarouselCard" xs={4}>
