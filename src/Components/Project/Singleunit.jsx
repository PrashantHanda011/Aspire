  ...
  return (
    ...
    <div className='Property-singleunit'>
        <div className='Property-singleunit-img'>
          <figure>
            <img src={props?.data?.floorPlan} onClick={handleOpen1} className='w-100' alt="" />
          </figure>
        </div>
        ...
        <div className='Property-singleunit-desc'>
            <button disabled={disable}  className="getprice-btn" onClick={handleOpen}>
              get Price
            </button>
        </div>
    </div>
        ...
        <hr />
          <form className='d-flex flex-wrap col-12 justify-content-between'>
                      <div class="form-group col-5 mb-4">
                        ...
                        <input type="text"   class="form-control" name="name" onChange={handleChange} id="exampleInputEmail1" aria-describedby="emailHelp"/>
                      </div>                    
                      <div class="form-group col-5">
                        <label for="exampleInputEmail1">Phone Number</label>
                        <input type="tel"  class="form-control" id="exampleInputEmail1" onChange={handleChange} name="phone" aria-describedby="emailHelp"    />
                      </div> 
                      
                      <div class="form-group col-5">
                        <label for="exampleInputEmail1">Email</label>
                        <input type="email"  class="form-control" onChange={handleChange} id="exampleInputEmail1" aria-describedby="emailHelp"  name="email"  />
                      </div>  
